...
export const createProductMain = async (params?: { [key: string]: any }) => {
  return request<ResponseDataType>('/api/product/createProductMain', {
    method: 'POST',
    data: params,
  });
};
...
export const editProductMain = async (params?: { [key: string]: any }) => {
  return request<ResponseDataType>('/api/product/editProductMain', {
    method: 'POST',
    data: params,
  });
};
...
export const delProductMain = async (params?: { [key: string]: any }) => {
  return request<ResponseDataType>('/api/product/delProductMain', {
    method: 'POST',
    data: params,
  });
};
...
export const queryProductMainAll = async (params?: { [key: string]: any }) => {
  return request<ResponseDataType>('/api/product/queryProductMainAll', {
    method: 'POST',
    data: params,
  });
};
...
export const queryProductMainDetail = async (params?: { [key: string]: any }) => {
  return request<ResponseDataType>('/api/product/queryProductMainDetail', {
    method: 'POST',
    data: params,
  });
};
...
export const queryProductMainOfferId = async (params?: { [key: string]: any }) => {
  return request<ResponseDataType>('/api/product/queryProductMainOfferId', {
    method: 'POST',
    data: params,
  });
};
